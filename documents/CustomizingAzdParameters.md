...
| `AZURE_ENV_MODEL_NAME`                 | string  | `gpt-4o`                   | Specifies the GPT model name (allowed: `gpt-4o`).                    |
...
| `AZURE_CONTAINER_REGISTRY_HOST`    | string  | `optisummitacr.azurecr.io`           | Sets the Azure Container Registry (OPTI Summit: `optisummitacr`)|
